...
urlpatterns = [
    ...
    path('visitor-checkout-guard/', gate_views.visitor_checkout_guard, name='visitor-checkout-guard'),
    ...
    path('visitor-scanner/', gate_views.visitor_scanner, name='visitor-scanner'),
