    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gate.JobCategory')),
            ],
        ),
        migrations.CreateModel(
            name='EventImage',
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='gate.Event')),
            ],
        ),
        migrations.CreateModel(
            name='EventCategory',
        ...
        migrations.AddField(
            model_name='event',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gate.EventCategory'),
        ),
        migrations.AddField(
            model_name='event',
            name='created_user',
        ...
        migrations.AddField(
            model_name='event',
            name='job_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gate.JobCategory'),
        ),
        migrations.AddField(
            model_name='event',
            name='updated_user',
